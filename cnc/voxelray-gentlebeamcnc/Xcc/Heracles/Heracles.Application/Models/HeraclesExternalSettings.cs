...
public class HeraclesExternalSettings(ISettingsReader reader) : Core.Models.IHeraclesExternalSettings
{
    ...
    public string? CameraUriSource { get; set; } = reader.GetOptionalString(
        ...
        defaultValue: "rtsp://Empyrean:Empyrean!2025@172.31.1.50:554/axis-media/media.amp");
    ...
    #region IWarmUpSettings
    public float WarmupSetpoint { get; set; } = reader.GetOptionalFloat("AppSettings:WarmupSetpoint", 3500.0f);
    public float FilamentSetpoint { get; } = reader.GetOptionalFloat("AppSettings:FilamentSetpoint", 3750.0f);
    public float ConditioningSetpoint { get; } = reader.GetOptionalFloat("AppSettings:ConditioningSetpoint", 3900.0f);
    public float ConditioningIntervalMinutes { get; } = reader.GetOptionalFloat("AppSettings:ConditioningIntervalMinutes", 24.0f * 60);
    #endregion IWarmUpSettings
